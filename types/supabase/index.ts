...
export type DBFeedback = Database['public']['Tables']['feedback']['Row']
...
export type DBFeedbackInsert = Database['public']['Tables']['feedback']['Insert']
...
export type DBFeedbackUpdate = Database['public']['Tables']['feedback']['Update']
